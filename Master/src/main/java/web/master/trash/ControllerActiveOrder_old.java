...
import web.master.mains.ControllerServiceList;
import web.master.mains.ControllerStaffList;
...
public class ControllerActiveOrder_old implements Initializable {
    ...
    public ControllerActiveOrder_old(Employee cEmployee) { _Employee = cEmployee;  };
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        b_activeOrder.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                fxmlLoader.setController( new ControllerActiveOrder_old(_Employee));
                Scene scene = null;
                try {
                    scene = new Scene(fxmlLoader.load());
                } catch (IOException e) {
...
/*                Stage newWindow = new Stage();
                ...
                fxmlLoader.setController( new ControllerActive_Filters(_Employee, b_listServices.getScene().setEventDispatcher();));
